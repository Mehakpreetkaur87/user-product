...
import { getProducts, createProduct, deleteProduct, getProductById } from "../contollers/product.controller.js";
...
router.get(":/id", checkAuth, validProduct, responseProcessor(getProductById))
// POST → admin only
router.post(
  "/products",
  checkAuth,
